package br.com.frezza.controller.resource;
...
public class CidadeResource {
	...
	@GetMapping ("/letra/{start}")
	public List<Cidade> buscarPelaLetraIncial (@PathVariable String start) {
		return cidadeRepo.findByNomeStartingWith(start);
	}
	
	@GetMapping ("/busca/{latitude}&{longitude}")
	public Cidade buscarPorLatitudeLongitude (@PathVariable String latitude, @PathVariable String longitude) {
